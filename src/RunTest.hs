...
-- runTest :: IO ()
-- runTest = do
--   let lubeckMarket = Market [MarketItem Grain (Price 100) 30, MarketItem Beer (Price 100) 10]
...
--   let lubeck = City portLubeck (Market [MarketItem Grain (Price 100) 50]) [(Grain, 5)] []
--   let hamburg = City portHamburg (Market [MarketItem Grain (Price 100) 10]) [] [(Grain, 3)]
...
--   let portHamburg = Port "Hamburg"
--   let portLubeck = Port "Lubeck"
--   let lubeck = City portLubeck (Market [MarketItem Grain (Price 100) 5000]) [(Grain, 5)] []
--   let hamburg = City portHamburg (Market [MarketItem Grain (Price 100) 1000]) [] [(Grain, 3)]
--   let myShip = Ship Cog 100 10 8.0 100 [] (InPort portLubeck)
